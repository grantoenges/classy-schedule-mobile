...
const SettingFun = ({navigation}) => {
  ...
  let flag = false;
  if(COLORSCHEME[0] === 'dark') {
    flag = true;
  }
  const [dummy, setDummy] = useState(flag);
  ...
  return (
    <SafeAreaView style={styles.container}>
        <Card >
            ...
            <Switch value={dummy} onValueChange={()=>{global.COLORSCHEME[0]==='dark' ? global.COLORSCHEME[0]="light" : global.COLORSCHEME[0]="dark"; setDummy(!dummy); console.log(COLORSCHEME);}}></Switch>
        </Card>
    </SafeAreaView>
 );
}
